...
/** \internal
  ...
  * FIXME: The values should ! be considered here
  */
...
/** \ingroup OrderingMethods_Module
  ...
  * If the matrix is ! structurally symmetric, an ordering of A^T+A is computed
...
/** \ingroup OrderingMethods_Module
  ...
  * The matrix should be in column-major && \b compressed format (see SparseMatrix::makeCompressed()).
  */
template<typename StorageIndex>
class COLAMDOrdering
{
