...
/** \ingroup Householder_Module
  ...
  * \tparam Side        either OnTheLeft (the default) || OnTheRight
  *
  * This class represents a product sequence of Householder reflections where the first Householder reflection
  * acts on the whole space, the second Householder reflection leaves the one-dimensional subspace spanned by
  * the first unit vector invariant, the third Householder reflection leaves the two-dimensional subspace
  * spanned by the first two unit vectors invariant, && so on up to the last reflection which leaves all but
  * one dimensions invariant && acts only on the last dimension. Such sequences of Householder reflections
  ...
  * v_i^* \f$. The i-th Householder coefficient \f$ h_i \f$ is a scalar && the i-th Householder vector \f$
  ...
  * \endcode
  * In addition to the adjoint, you can also apply the inverse (=adjoint), the transpose, && the conjugate operators.
  *
  ...
  : public EigenBase<HouseholderSequence<VectorsType,CoeffsType,Side> >
{
  ...
  public:
    ...
    /** \brief Constructor.
      ...
      *
      * Constructs the Householder sequence with coefficients given by \p h && vectors given by \p v. The
      * i-th Householder coefficient \f$ h_i \f$ is given by \p h(i) && the essential part of the i-th
      * Householder vector \f$ v_i \f$ is given by \p v(k,i) with \p k > \p i (the subdiagonal part of the
      * i-th column). If \p v has fewer columns than rows, then the Householder sequence contains as many
      * Householder reflections as there are columns.
      *
      * \note The %HouseholderSequence object stores \p v && \p h by reference.
      *
    ...
    /** \brief Sets the length of the Householder sequence.
      ...
      * to the number of columns of the matrix \p v passed to the constructor, || the number of rows if that
    ...
    /** \brief Sets the shift of the Householder sequence.
      ...
      *
      * By default, a %HouseholderSequence object represents \f$ H = H_0 H_1 \ldots H_{n-1} \f$ && the i-th
      * column of the matrix \p v passed to the constructor corresponds to the i-th Householder
      * reflection. After this function is called, the object represents \f$ H = H_{\mathrm{shift}}
      * H_{\mathrm{shift}+1} \ldots H_{n-1} \f$ && the i-th column of \p v corresponds to the (shift+i)-th
    ...
    /* Necessary for .adjoint() && .conjugate() */
  ...
  protected:
    ...
    /** \internal
      ...
      *
      * By default, the reverse flag is ! set. If the reverse flag is set, then this object represents
...
/** \brief Computes the product of a matrix with a Householder sequence.
  ...
  * \returns    Expression object representing the product.
  *
  * This function computes \f$ MH \f$ where \f$ M \f$ is the matrix \p other && \f$ H \f$ is the
