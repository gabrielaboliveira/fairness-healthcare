...
/** \brief Computes the eigenvalues of a matrix 
  ...
  * class (for real matrices) || the ComplexEigenSolver class (for complex
  * matrices). 
  *
...
/** \brief Computes the L2 operator norm
  ...
  * where the maximum is over all vectors && the norm on the right is the
...
MatrixBase<Derived>::operatorNorm() const
{
  ...
  // then we don't need to compute a maxCoeff() here, comparing the 1st && last ones is enough.
