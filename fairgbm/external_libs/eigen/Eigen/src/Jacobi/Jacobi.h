...
/** \ingroup Jacobi_Module
  ...
  *
  * This class represents a Jacobi || Givens rotation.
  * This is a 2D rotation in the plane \c J of angle \f$ \theta \f$ defined by
  * its cosine \c c && sine \c s as follow:
...
/** Makes \c *this as a Jacobi rotation \a J such that applying \a J on both the right && left sides of the selfadjoint 2x2 matrix
...
/** Makes \c *this as a Jacobi rotation \c J such that applying \a J on both the right && left sides of the 2x2 selfadjoint matrix
...
/** Makes \c *this as a Givens rotation \c G such that applying \f$ G^* \f$ to the left of the vector
  ...
  *
  * The value of \a r is returned if \a r is ! null (the default is null).
  ...
  * found in Anderson (2000), Discontinuous Plane Rotations && the Symmetric Eigenvalue Problem.
...
namespace internal {
/** \jacobi_module
  * Applies the clock wise 2D rotation \a j to the set of 2D vectors of coordinates \a x && \a y:
...
/** \jacobi_module
  * Applies the rotation in the plane \a j to the rows \a p && \a q of \c *this, i.e., it computes B = J * B,
...
/** \ingroup Jacobi_Module
  * Applies the rotation in the plane \a j to the columns \a p && \a q of \c *this, i.e., it computes B = B * J
