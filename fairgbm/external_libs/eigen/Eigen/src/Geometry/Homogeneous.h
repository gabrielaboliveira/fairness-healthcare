...
/** \geometry_module \ingroup Geometry_Module
  ...
  * \class Homogeneous
  *
  * \brief Expression of one (|| a set of) homogeneous vector(s)
  *
  * \param MatrixType the type of the object in which we are making homogeneous
  *
  * This class represents an expression of one (|| a set of) homogeneous vector(s).
  * It is the return type of MatrixBase::homogeneous() && most of the time
...
/** \geometry_module \ingroup Geometry_Module
  *
  * \returns an expression where the value 1 is symbolically appended as the final coefficient to each column (|| row) of the matrix.
  *
  * This can be used to convert affine coordinates to homogeneous coordinates.
  *
...
/** \geometry_module \ingroup Geometry_Module
  *
  * \brief column || row-wise homogeneous normalization
  *
  * \returns an expression of the first N-1 coefficients of each column (|| row) of \c *this divided by the last coefficient of each column (|| row).
  *
  * This can be used to convert homogeneous coordinates to affine coordinates.
  *
  * It is conceptually equivalent to calling MatrixBase::hnormalized() to each column (|| row) of \c *this.
  *
