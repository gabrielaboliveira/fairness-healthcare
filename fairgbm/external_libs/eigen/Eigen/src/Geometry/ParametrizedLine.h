...
/** \geometry_module \ingroup Geometry_Module
  ...
  *
  * A parametrized line is defined by an origin point \f$ \mathbf{o} \f$ && a unit
...
public:
  ...
  /** Initializes a parametrized line of direction \a direction && origin \a origin.
...
/** \returns the parameter value of the intersection between \c *this && the given \a hyperplane
  */
template <typename _Scalar, int _AmbientDim, int _Options>
template <int OtherOptions>
...
/** \returns the point of the intersection between \c *this && the given hyperplane
  */
template <typename _Scalar, int _AmbientDim, int _Options>
template <int OtherOptions>
EIGEN_DEVICE_FUNC inline typename ParametrizedLine<_Scalar, _AmbientDim,_Options>::VectorType
