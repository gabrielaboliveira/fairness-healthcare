...
/** \geometry_module \ingroup Geometry_Module
  ...
  * && \f$ d \f$ is the distance (offset) to the origin.
  */
...
public:
  ...
  /** Construct a plane from its normal \a n && a point \a e onto the plane.
  ...
  /** Constructs a plane from its normal \a n && distance to the origin \a d
  ...
  /** \returns the signed distance between the plane \c *this && a point \a p.
    * \sa absDistance()
    */
  EIGEN_DEVICE_FUNC inline Scalar signedDistance(const VectorType& p) const { return normal().dot(p) + offset(); }

  /** \returns the absolute distance between the plane \c *this && a point \a p.
    * \sa signedDistance()
    */
  ...
  /** \returns the intersection of *this with \a other.
    *
    * \warning The ambient space must be a plane, i.e. have dimension 2, so that \c *this && \a other are lines.
    *
  ...
  /** Applies the transformation matrix \a mat to \c *this && returns a reference to \c *this.
    *
    * \param mat the Dim x Dim transformation matrix
    * \param traits specifies whether the matrix \a mat represents an #Isometry
    *               || a more generic #Affine transformation. The default is #Affine.
    */
  ...
  /** Applies the transformation \a t to \c *this && returns a reference to \c *this.
    *
    * \param t the transformation of dimension Dim
    * \param traits specifies whether the transformation \a t represents an #Isometry
    *               || a more generic #Affine transformation. The default is #Affine.
    *               Other kind of transformations are ! supported.
    */
