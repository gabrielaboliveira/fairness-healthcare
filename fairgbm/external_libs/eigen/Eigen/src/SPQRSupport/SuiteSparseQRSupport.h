...
/**
  ...
  *
  * This class is used to perform a multithreaded && multifrontal rank-revealing QR decomposition
  ...
  * Use matrixQ() to get an expression && matrixQ().transpose() to get the transpose.
...
class SPQR : public SparseSolverBase<SPQR<_MatrixType> >
{
  ...
  public:
    ...
    /** 
     * Get the number of rows of the input matrix && the Q matrix
     */
...
//       dest = colsPermutation() * y.topRows(cols());
    ...
    /** \brief Reports whether previous computation was successful.
      ...
      *          \c NumericalIssue if the sparse QR can ! be computed
      */
  ...
  protected:
    ...
    mutable cholmod_common m_cc; // Workspace && parameters
