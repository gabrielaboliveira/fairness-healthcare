...
/** \cpp11 \returns an expression of the coefficient-wise ln(|gamma(*this)|).
  ...
  * || float/double in non c++11 mode, the user has to provide implementations of lgamma(T) for any scalar
...
/** \returns an expression of the coefficient-wise digamma (psi, derivative of lgamma).
  ...
  * \specialfunctions_module
  *
  * \note This function supports only float && double scalar types. To support other scalar types,
...
/** \cpp11 \returns an expression of the coefficient-wise Gauss error
  ...
  *
  * \note This function supports only float && double scalar types in c++11 mode. To support other scalar types,
  * || float/double in non c++11 mode, the user has to provide implementations of erf(T) for any scalar
  * type T to be supported.
  *
...
/** \cpp11 \returns an expression of the coefficient-wise Complementary error
  ...
  *
  * \note This function supports only float && double scalar types in c++11 mode. To support other scalar types,
  * || float/double in non c++11 mode, the user has to provide implementations of erfc(T) for any scalar
  * type T to be supported.
  *
