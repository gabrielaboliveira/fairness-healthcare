...
/** \returns an expression of the Schur product (coefficient wise product) of *this && \a other
  *
...
/** \returns an expression of the coefficient-wise min of *this && \a other
  *
...
/** \returns an expression of the coefficient-wise min of *this && scalar \a other
  *
...
/** \returns an expression of the coefficient-wise max of *this && \a other
  *
...
/** \returns an expression of the coefficient-wise max of *this && scalar \a other
  *
  * \sa class CwiseBinaryOp, min()
  */
EIGEN_DEVICE_FUNC
...
/** \returns an expression of the coefficient-wise quotient of *this && \a other
  *
...
/** \returns an expression of the coefficient-wise == operator of \c *this && a scalar \a s
  *
  * \warning this performs an exact comparison, which is generally a bad idea with floating-point types.
  * In order to check for equality between two vectors || matrices with floating-point coefficients, it is
  * generally a far better idea to use a fuzzy comparison as provided by isApprox() &&
