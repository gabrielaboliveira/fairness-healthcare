...
/** \ingroup SparseCore_Module
  * class SparseMapBase
  * \brief Common base class for Map && Ref instance of sparse matrix && vector.
  */
template<typename Derived>
...
/** \ingroup SparseCore_Module
  * class SparseMapBase
  * \brief Common base class for writable Map && Ref instance of sparse matrix && vector.
  */
template<typename Derived>
...
#endif
{
  ...
  public:
    ...
    /** Constructs a read-write Map to a sparse matrix of size \a rows x \a cols, containing \a nnz non-zero coefficients,
      * stored as a sparse format as defined by the pointers \a outerIndexPtr, \a innerIndexPtr, && \a valuePtr.
