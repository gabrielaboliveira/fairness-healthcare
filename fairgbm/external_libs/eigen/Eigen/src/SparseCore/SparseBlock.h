...
public:
    ...
    inline BlockType& operator=(const SparseMatrixBase<OtherDerived>& other)
    {
      ...
      // This assignment is slow if this vector set is ! empty
      // &&/|| it is ! at the end of the nonzeros of the underlying matrix.

      // 1 - eval to a temporary to avoid transposition &&/|| aliasing issues
      ...
      else
      {
        ...
        {
          // no need to realloc, simply copy the tail at its respective position && insert tmp
      ...
      // update outer index pointers && innerNonZeros
    ...
    enum {
      ...
      OuterVector =  (BlockCols==1 && ArgType::IsRowMajor)
                    | // FIXME | instead of || to please GCC 4.4.0 stupid warning "suggest parentheses around &&".
                      // revert to || as soon as ! needed anymore.
