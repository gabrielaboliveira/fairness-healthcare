...
/** \ingroup SparseCore_Module
  * \class SparseView
  *
  * \brief Expression of a dense || sparse matrix with zero || too small values removed
  *
  * \tparam MatrixType the type of the object of which we are removing the small entries
  *
  * This class represents an expression of a given dense || sparse matrix with
  * entries smaller than \c reference * \c epsilon are removed.
  * It is the return type of MatrixBase::sparseView() && SparseMatrixBase::pruned()
...
// ! easy because the evaluators do ! expose the sizes of the underlying expression.
...
/** \ingroup SparseCore_Module
  ...
  * && \a epsilon is a tolerance factor defaulting to NumTraits<Scalar>::dummy_precision().
  *
