...
{
  // by default sparse evaluation do ! alias, so we can safely bypass the generic call_assignment routine
...
// Specialization for dense ?= dense +/- sparse && dense ?= sparse +/- dense
