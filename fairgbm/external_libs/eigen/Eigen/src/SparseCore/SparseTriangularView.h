...
/** \ingroup SparseCore_Module
  ...
  *
  * This class is an abstract base class of class TriangularView, && objects of type TriangularViewImpl cannot be instantiated.
  ...
  : public SparseMatrixBase<TriangularView<MatrixType,Mode> >
{
  ...
  public:
    ...
    /** Applies the inverse of \c *this to the dense vector || matrix \a other, "in-place" */
    template<typename OtherDerived> void solveInPlace(MatrixBase<OtherDerived>& other) const;

    /** Applies the inverse of \c *this to the sparse vector || matrix \a other, "in-place" */
