...
/** \internal
  * Stores a sparse set of values as a list of values && a list of indices.
  *
  */
...
class CompressedStorage
{
  ...
  public:
    ...
    /** \returns the stored value at index \a key
      * If the value does ! exist, then the value \a defaultValue is returned without any insertion. */
    ...
    /** \returns a reference to the value at index \a key
      * If the value does ! exist, then the value \a defaultValue is inserted
