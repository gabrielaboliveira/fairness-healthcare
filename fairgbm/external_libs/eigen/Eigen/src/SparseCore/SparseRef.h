...
/** 
  ...
  * \tparam Options specifies whether the a standard compressed format is required \c Options is  \c #StandardCompressedFormat, || \c 0.
  *                The default is \c 0.
  *
  * \sa class Ref
  */
...
#endif
{
  ...
  public:
    ...
    #else
    /** Implicit constructor from any sparse expression (2D matrix || 1D vector) */
    template<typename Derived>
  ...
  : public internal::SparseRefBase<Ref<const SparseMatrix<MatScalar,MatOptions,MatIndex>, Options, StrideType> >
{
  ...
  public:
    ...
    inline Ref(const Ref& other) : Base(other), m_hasCopy(false) {
      // copy constructor shall ! copy the m_object, to avoid unnecessary malloc && copy
    }
...
// FIXME shall we introduce a general evaluatior_ref that we can specialize for any sparse object once, && thus remove this copy-pasta thing...
