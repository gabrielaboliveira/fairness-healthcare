...
//  4 - dense op dense
// Finally, we also need to distinguish between the product && other operations :
...
//      && fallback to cwise-unary evaluator using bind1st_op && bind2nd_op.
...
/***************************************************************************
* Implementation of SparseMatrixBase && SparseCwise functions/operators
***************************************************************************/
