  ...
  : public SparseCompressedBase<SparseVector<_Scalar, _Options, _StorageIndex> >
{
  ...
  public:
    ...
    /** \returns a reference to the coefficient value at given index \a i
      * This operation involes a log(rho*size) binary search. If the coefficient does !
  ...
  public:
    ...
    /** Resizes the sparse vector to \a newSize, while leaving old values untouched.
      *
      * If the size of the vector is decreased, then the storage of the out-of bounds coefficients is kept && reserved.
    ...
    /** Swaps the values of \c *this && \a other.
      * Overloaded for performance: this version performs a \em shallow swap by swapping pointers && attributes only.
  ...
  public:
    ...
    /** \internal \deprecated use setZero() && reserve() */
