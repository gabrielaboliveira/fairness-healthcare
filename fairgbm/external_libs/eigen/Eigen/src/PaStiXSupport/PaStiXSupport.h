...
/** \ingroup PaStiXSupport_Module
  ...
  * The matrix can be either real || complex, symmetric || !.
  *
...
// Users should ! used this class directly. 
...
class PastixBase : public SparseSolverBase<Derived>
{
  ...
  public:
    ...
    /** Returns a reference to the integer vector IPARM of PaStiX parameters
      ...
      * The statistics related to the different phases of factorization && solve are saved here as well
  ...
  protected:
    ...
    // Compute the ordering && the symbolic factorization
 ...
 /** Initialize the PaStiX data structure. 
   *A first call to this function fills iparm && dparm with the default PaStiX parameters
   * \sa iparm() dparm()
   */
template <class Derived>
...
/** \ingroup PaStiXSupport_Module
  ...
  * factorization in the PaStiX library. The matrix A should be squared && nonsingular
  ...
  * NOTE : Note that if the analysis && factorization phase are called separately, 
  * the input matrix will be symmetrized at each call, hence it is advised to 
  * symmetrize the matrix in a end-user program && set \p IsStrSym to true
  *
...
class PastixLU : public PastixBase< PastixLU<_MatrixType> >
{
  ...
  public:
    ...
    /** Compute the LU supernodal factorization of \p matrix. 
      * iparm && dparm can be used to tune the PaStiX parameters. 
...
/** \ingroup PaStiXSupport_Module
  * \class PastixLLT
  * \brief A sparse direct supernodal Cholesky (LLT) factorization && solver based on the PaStiX library
  * 
  * This class is used to solve the linear systems A.X = B via a LL^T supernodal Cholesky factorization
  * available in the PaStiX library. The matrix A should be symmetric && positive definite
  * WARNING Selfadjoint complex matrices are ! supported in the current version of PaStiX
  * The vectors || matrices X && B can be either dense || sparse
  * 
  * \tparam MatrixType the type of the sparse matrix A, it must be a SparseMatrix<>
  * \tparam UpLo The part of the matrix to use : Lower || Upper. The default is Lower as required by PaStiX
  *
  * \implsparsesolverconcept
  *
...
class PastixLDLT : public PastixBase< PastixLDLT<_MatrixType, _UpLo> >
{
  ...
  public:
    ...
    /** Compute the L && D factors of the LDL^T factorization of \p matrix 
      * \sa analyzePattern() factorize()
      */
    void compute (const MatrixType& matrix)
    {
