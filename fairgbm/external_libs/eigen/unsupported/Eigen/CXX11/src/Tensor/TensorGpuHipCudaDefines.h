...
// This will obsviously ! work when trying to compile tensorflow on a system with no CUDA
// To work around this issue for HIP systems (&& leave the default behaviour intact), the
...
// HIPCC do ! support the use of assert on the GPU side.
