...
struct TensorEvaluator
{
  ...
  // Packet16f, `umask` is of type uint16_t && if a bit is 1, corresponding
...
struct TensorEvaluator<const TensorCwiseTernaryOp<TernaryOp, Arg1Type, Arg2Type, Arg3Type>, Device>
{
  ...
  EIGEN_DEVICE_FUNC const Dimensions& dimensions() const
  {
    // TODO: use arg2 || arg3 dimensions if they are known at compile time.
...
struct TensorEvaluator<const TensorSelectOp<IfArgType, ThenArgType, ElseArgType>, Device>
{
  ...
  EIGEN_DEVICE_FUNC const Dimensions& dimensions() const
  {
    // TODO: use then || else impl instead if they happen to be known at compile time.
