...
struct TensorEvaluator<const TensorReverseOp<ReverseDimensions, ArgType>, Device>
{
  ...
  internal::TensorBlockResourceRequirements getResourceRequirements() const {
    ...
    // Block evaluation reads underlying memory in reverse order, && default
    // cost model does ! properly catch this in bytes stored/loaded.
  ...
  block(TensorBlockDesc& desc, TensorBlockScratch& scratch,
    ...
    // TODO(ezhulenev): If underlying tensor expression supports && prefers
    // block evaluation we must use it. Currently we use coeff && packet
