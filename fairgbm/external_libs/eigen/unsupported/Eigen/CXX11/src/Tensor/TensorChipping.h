...
/** \class TensorKChippingReshaping
  ...
  *
  * \brief A chip is a thin slice, corresponding to a column || a row in a 2-d tensor.
  *
  *
  */
...
struct TensorEvaluator<const TensorChippingOp<DimId, ArgType>, Device>
{
  ...
  enum {
    ...
    // read && write directly from the underlying tensor using single offset.
