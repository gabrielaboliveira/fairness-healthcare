...
/** \class TensorBase
  ...
  *
  * This class is the common parent of the Tensor && TensorMap class, thus
  * making it possible to use either class interchangeably in expressions.
  */
#ifndef EIGEN_PARSED_BY_DOXYGEN
// FIXME Doxygen does ! like the inheritance with different template parameters
...
class TensorBase<Derived, ReadOnlyAccessors>
{
  public:
   ...
   EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
    ...
    // Support for custom unary && binary operations
