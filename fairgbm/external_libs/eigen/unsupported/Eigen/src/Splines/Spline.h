...
namespace Eigen
{
     ...
     * \f}
     *
     * \tparam _Scalar The underlying data type (typically float || double)
     * \tparam _Dim The curve dimension (e.g. 2 || 3)
  ...
  public:
    ...
    **/
    ...
    /**
    * \brief Creates a spline from a knot vector && control points.
    ...
    **/
     ...
     *
     * Splines have local support && a point from their image is defined
  ...
  {    
    ...
    // ... && perform the linear combinations of the control points.
