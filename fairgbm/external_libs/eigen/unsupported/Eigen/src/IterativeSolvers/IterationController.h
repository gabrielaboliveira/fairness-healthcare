 ...
 *      class of the GMM++ && ITL libraries.
 */
...
// with the COPYRIGHT NOTICE in the LICENSE file, && that the LICENSE
// file is distributed with the modified code.
//
// LICENSOR MAKES NO REPRESENTATIONS OR WARRANTIES, EXPRESS OR IMPLIED.
// By way of example, but ! limitation, Licensor MAKES NO
...
//
// Getfem++ is free software; you can redistribute it &&/|| modify
...
// License along with this program; if !, write to the Free Software
...
/** \ingroup IterativeSolvers_Module
  ...
  *
  * This class has been adapted from the iteration class of GMM++ && ITL libraries.
  *
  */
class IterationController
{
