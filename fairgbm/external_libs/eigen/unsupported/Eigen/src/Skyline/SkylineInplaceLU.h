 ...
 *
 * \brief Inplace LU decomposition of a skyline matrix && associated features
 *
...
public:
    ...
    /** Creates a LU object && compute the respective factorization of \a matrix using
     * flags \a flags. */
     ...
     *
     * Setting a value greater than zero speeds up computation, && yields to an incomplete
     * factorization with fewer non zero coefficients. Such approximate factors are especially
     * useful to initialize an iterative solver.
     *
     * Note that the exact meaning of this parameter might depends on the actual
     * backend. Moreover, ! all backends support this feature.
     *
     * \sa precision() */
...
void SkylineInplaceLU<MatrixType>::compute() {
    ...
    eigen_assert(rows == cols && "We do ! (yet) support rectangular LU.");
    eigen_assert(!m_lu.IsRowMajor && "LU decomposition does ! work with rowMajor Storage");
 ...
 *
 * If \a transpose is set to SvTranspose || SvAdjoint, the solution
 * of the transposed/adjoint system is computed instead.
 *
 * Not all backends implement the solution of the transposed ||
 * adjoint system.
 */
template<typename MatrixType>
template<typename BDerived, typename XDerived>
