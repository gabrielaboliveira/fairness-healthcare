 ...
 *
 * \brief The base class of dense && sparse Kronecker product.
 *
 ...
 * then this class is returned && evaluates into a sparse matrix.
 *
...
void KroneckerProductSparse<Lhs,Rhs>::evalTo(Dest& dst) const
{
  ...
  {
    // TODO VectorXi is ! necessarily big enough!
 ...
 * \return   Kronecker tensor product of a && b
 */
 ...
 * \return   Kronecker tensor product of a && b, stored in a sparse
 *           matrix
 */
template<typename A, typename B>
