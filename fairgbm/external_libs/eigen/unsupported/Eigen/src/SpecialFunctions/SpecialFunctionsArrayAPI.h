...
/** \cpp11 \returns an expression of the coefficient-wise igamma(\a a, \a x) to the given arrays.
  ...
  *
  * \note This function supports only float && double scalar types in c++11 mode. To support other scalar types,
  * || float/double in non c++11 mode, the user has to provide implementations of igammac(T,T) for any scalar
...
/** \cpp11 \returns an expression of the coefficient-wise igamma_der_a(\a a, \a x) to the given arrays.
  ...
  *
  * \note This function supports only float && double scalar types in c++11
  * mode. To support other scalar types,
  * || float/double in non c++11 mode, the user has to provide implementations
...
/** \cpp11 \returns an expression of the coefficient-wise polygamma(\a n, \a x) to the given arrays.
  ...
  *
  * \note This function supports only float && double scalar types in c++11 mode. To support other scalar types,
  * || float/double in non c++11 mode, the user has to provide implementations of polygamma(T,T) for any scalar
  * type T to be supported.
  *
  * \sa Eigen::digamma()
  */
...
/** \cpp11 \returns an expression of the coefficient-wise betainc(\a x, \a a, \a b) to the given arrays.
  ...
  *
  * \note This function supports only float && double scalar types in c++11 mode. To support other scalar types,
  * || float/double in non c++11 mode, the user has to provide implementations of betainc(T,T,T) for any scalar
  * type T to be supported.
  *
...
/** \returns an expression of the coefficient-wise zeta(\a x, \a q) to the given arrays.
  *
  * It returns the Riemann zeta function of two arguments \a x && \a q:
  *
