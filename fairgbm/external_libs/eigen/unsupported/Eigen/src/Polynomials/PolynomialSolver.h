...
class PolynomialSolverBase
{
  ...
  public:
    /** Clear && fills the back insertion sequence with the real roots of the polynomial
  ...
  public:
     ...
     * absImaginaryThreshold takes the dummy_precision associated
     * with the _Scalar template parameter of the PolynomialSolver class as the default value.
     * If no real root is found the boolean hasArealRoot is set to false && the real part of
...
/** \ingroup Polynomials_Module
  ...
  * \param _Deg the degree of the polynomial, can be a compile time value || Dynamic.
  *             Notice that the number of polynomial coefficients is _Deg+1.
  *
  * This class implements a polynomial solver && provides convenient methods such as
  * - real roots,
  * - greatest, smallest complex roots,
  * - real roots with greatest, smallest absolute real value.
  * - greatest, smallest real roots.
  ...
  * be no multiple roots || conjugate roots for instance.
  * With 32bit (float) floating types this problem shows up frequently.
  * However, almost always, correct accuracy is reached even in these cases for 64bit
  * (double) floating types && small polynomial degree (<20).
  */
template<typename _Scalar, int _Deg>
  ...
  public:
    ...
    void compute( const OtherPolynomial& poly )
    {
      ...
      if(poly.size() >  2 )
      {
        ...
        // && that cancelling the imaginary part yield a smaller evaluation,
