...
//       all blocks of sqrtT to left of && below (i,j) are correct
...
// pre:  T is quasi-upper-triangular && sqrtT is a zero matrix of the same size
...
// pre:  T is quasi-upper-triangular && diagonal blocks of sqrtT are square root of diagonal blocks of T.
...
/** \ingroup MatrixFunctions_Module
  ...
  *
  * Only the upper triangular part (including the diagonal) of \p result is updated, the rest is !
  * touched.  See MatrixBase::sqrt() for details on how this computation is implemented.
  *
  * \sa MatrixSquareRoot, MatrixSquareRootQuasiTriangular
  */
...
void matrix_sqrt_triangular(const MatrixType &arg, ResultType &result)
{
  ...
  // Compute square root of arg && store it in upper triangular part of result
...
/** \ingroup MatrixFunctions_Module
  ...
  * is assigned || evaluated for some other reason (so the argument
  * should ! be changed in the meantime). It is the return type of
  * MatrixBase::sqrt() && most of the time this is the only way it is
  * used.
  */
