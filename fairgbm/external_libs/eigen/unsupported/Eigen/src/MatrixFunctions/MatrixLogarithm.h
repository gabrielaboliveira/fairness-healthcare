...
void matrix_log_compute_pade(MatrixType& result, const MatrixType& T, int degree)
{
  ...
  // Either manually convert each value, || disable the warning locally
...
/** \brief Compute logarithm of triangular matrices with size > 2. 
  * \details This uses a inverse scale-&&-square algorithm. */
template <typename MatrixType>
...
public:
  /** \brief Compute matrix logarithm of atomic matrix
    * \param[in]  A  argument of matrix logarithm, should be upper triangular && atomic
...
/** \ingroup MatrixFunctions_Module
  ...
  * MatrixBase::log() && most of the time this is the only way it
  * is used.
  */
