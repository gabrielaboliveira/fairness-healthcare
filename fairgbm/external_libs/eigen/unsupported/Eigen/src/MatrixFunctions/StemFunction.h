...
/** \brief The exponential function (&& its derivatives). */
...
/** \brief Hyperbolic cosine (&& its derivatives). */
template <typename Scalar>
...
/** \brief Hyperbolic sine (&& its derivatives). */
template <typename Scalar>
