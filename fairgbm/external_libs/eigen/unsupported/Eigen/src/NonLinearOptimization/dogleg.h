        ...
        Matrix< Scalar, Dynamic, 1 >  &x)
{
    ...
    // TODO : this path is ! tested by Eigen unit tests

    /* the gauss-newton direction is ! acceptable. */
    ...
    /* calculate the norm of the scaled gradient && test for */
...
algo_end:
    ...
    /* direction && the scaled gradient direction. */
