...
//    typedef typename QRSolver::StorageIndex StorageIndex;
    ...
    /* compute && store in x the gauss-newton direction. if the */
    ...
    /* evaluate the function at the origin, && test */
    ...
    /* if the jacobian is ! rank deficient, the newton */
    ...
    while (true) {
      ...
      /* is zero || the number of iterations has reached 10. */
      ...
      /* depending on the sign of the function, update parl || paru. */
      if (fp > 0.)
