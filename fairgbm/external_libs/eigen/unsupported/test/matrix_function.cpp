...
// Returns a matrix with eigenvalues clustered around 0, 1 && 2.
...
{
  // Returns a matrix with eigenvalues clustered around 0 && +/- i.
...
void testMatrixType(const MatrixType& m)
{
  ...
  // in MatrixFunction.h && are thus useful for testing.
...
{
  // Test if passing Ref && Map objects is possible
