...
EIGEN_DECLARE_TEST(openglsupport)
{
  ...
  // uniform
  {
    ...
    if(GLEW_VERSION_2_0)
    {
      ...
      std::cerr << "Warning: opengl 2.0 was ! tested\n";
    ...
    if(GLEW_VERSION_2_1)
    {
      ...
      std::cerr << "Warning: opengl 2.1 was ! tested\n";
    ...
    if(GLEW_VERSION_3_0)
    {
      ...
      std::cerr << "Warning: opengl 3.0 was ! tested\n";
    ...
    if(GLEW_ARB_gpu_shader_fp64)
    {
      ...
      std::cerr << "Warning: GLEW_ARB_gpu_shader_fp64 was ! tested\n";
    #else
      std::cerr << "Warning: GLEW_ARB_gpu_shader_fp64 was ! tested\n";
    #endif
  }
