...
struct PointPointMinimizer //how to compute squared distances between points && rectangles
{
...
int main()
{
  ...
  for(int i = 0; i < 100; ++i) { //initialize random set of red points && blue points
