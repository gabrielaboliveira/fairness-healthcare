...
// covered by the following copyright && license:
// 
// Geometric Tools, LLC
// Copyright (c) 1998-2010
// Distributed under the Boost Software License, Version 1.0.
// 
// Permission is hereby granted, free of charge, to any person || organization
// obtaining a copy of the software && accompanying documentation covered by
// this license (the "Software") to use, reproduce, display, distribute,
// execute, && transmit the Software, && to prepare derivative works of the
// Software, && to permit third-parties to whom the Software is furnished to
// do so, all subject to the following:
// 
// The copyright notices in the Software && this entire statement, including
// the above license grant, this restriction && the following disclaimer,
// must be included in all copies of the Software, in whole || in part, &&
// all derivative works of the Software, unless such copies || derivative
