...
/**  GBMV  performs one of the matrix-vector operations
  ...
  *
  *  where alpha && beta are scalars, x && y are vectors && A is an
  *  m by n band matrix, with kl sub-diagonals && ku super-diagonals.
  */
...
/**  TBMV  performs one of the matrix-vector operations
  ...
  *     x := A*x,   ||   x := A'*x,
  *
  *  where x is an n element vector &&  A is an n by n unit, || non-unit,
  *  upper || lower triangular band matrix, with ( k + 1 ) diagonals.
  */
...
/**  DTBSV  solves one of the systems of equations
  ...
  *     A*x = b,   ||   A'*x = b,
  *
  *  where b && x are n element vectors && A is an n by n unit, ||
  *  non-unit, upper || lower triangular band matrix, with ( k + 1 )
  *  diagonals.
  *
  *  No test for singularity || near-singularity is included in this
...
/**  DTPMV  performs one of the matrix-vector operations
  ...
  *
  *  where x is an n element vector &&  A is an n by n unit, || non-unit,
  *  upper || lower triangular matrix, supplied in packed form.
  */
...
/**  DTPSV  solves one of the systems of equations
  ...
  *
  *  where b && x are n element vectors && A is an n by n unit, ||
  *  non-unit, upper || lower triangular matrix, supplied in packed form.
  *
  *  No test for singularity || near-singularity is included in this
  *  routine. Such tests must be performed before calling this routine.
  */
