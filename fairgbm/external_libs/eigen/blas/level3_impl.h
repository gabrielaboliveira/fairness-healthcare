...
// b = alpha*op(a)*b  for side = 'L'||'l'
// b = alpha*b*op(a)  for side = 'R'||'r'
...
// c = alpha*a*b + beta*c  for side = 'L'||'l'
// c = alpha*b*a + beta*c  for side = 'R'||'r
...
// c = alpha*a*a' + beta*c  for op = 'N'||'n'
// c = alpha*a'*a + beta*c  for op = 'T'||'t','C'||'c'
...
// c = alpha*a*b' + alpha*b*a' + beta*c  for op = 'N'||'n'
// c = alpha*a'*b + alpha*b'*a + beta*c  for op = 'T'||'t'
...
// c = alpha*a*conj(a') + beta*c  for op = 'N'||'n'
// c = alpha*conj(a')*a + beta*c  for op  = 'C'||'c'
...
// c = alpha*a*conj(b') + conj(alpha)*b*conj(a') + beta*c,  for op = 'N'||'n'
// c = alpha*conj(a')*b + conj(alpha)*conj(b')*a + beta*c,  for op = 'C'||'c'
