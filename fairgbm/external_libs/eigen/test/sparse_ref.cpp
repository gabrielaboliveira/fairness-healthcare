...
//   VERIFY_EVALUATION_COUNT( call_ref_1(Ac, Ac),  0); // does ! compile on purpose
...
//   VERIFY_EVALUATION_COUNT( call_ref_1(Arc, Arc),  0); // does ! compile on purpose
  ...
  // VERIFY_EVALUATION_COUNT( call_ref_4(A.row(2), A.row(2).transpose()),  1); // does ! compile on purpose
