...
template<typename MatrixType> void lu_non_invertible()
{
  ...
  */
  ...
  // The kernel of the zero matrix is the entire space, && thus is an invertible matrix of dimensions cols.
  ...
  // of singular values are either 0 || 1.
  // So it's ! clear at all that the epsilon should play any role there.
