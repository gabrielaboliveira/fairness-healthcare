...
EIGEN_DECLARE_TEST(meta)
{
  ...
  //STATIC_CHECK((!internal::is_convertible<Matrix3f,Matrix3d>::value )); //does ! even compile because the conversion is prevented by a static assertion
  ...
  // In other word, it does ! obey SFINAE.
