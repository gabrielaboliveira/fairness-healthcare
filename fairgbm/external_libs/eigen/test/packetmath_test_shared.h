...
EIGEN_TEST_MAKE_BITWISE(&&,std::bit_and<unsigned char>())
EIGEN_TEST_MAKE_BITWISE(||, std::bit_or<unsigned char>())
struct bit_andnot{
...
// NOTE: we disable inlining for this function to workaround a GCC issue when using -O3 && the i387 FPU.
