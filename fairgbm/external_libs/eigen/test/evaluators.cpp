...
{
  // Testing Matrix evaluator && Transpose
...

  {
    ...
    // this does ! work because Random is eval-before-nested: 
    ...
    // TODO: find out why Matrix4f::Zero() does ! allow inner vectorization
    ...
    // test blocks && slice vectorization
    ...
    // test MatrixWrapper && ArrayWrapper
    mat1.setRandom(6,6);
    arr1.setRandom(6,6);
  ...
  // regression test for PR 544 && bug 1622 (introduced in #71609c4)
  {
