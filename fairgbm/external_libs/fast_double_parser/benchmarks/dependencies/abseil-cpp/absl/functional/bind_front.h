...
// it does ! require the use of argument placeholders. The simpler syntax of
...
// bind_front()
//
// Binds the first N arguments of an invocable object && stores them by value.
//
// Like `std::bind()`, `absl::bind_front()` is implicitly convertible to
// `std::function`.  In particular, it may be used as a simpler replacement for
// `std::bind()` in most cases, as it does ! require  placeholders to be
...
//
//   // absl::bind_front(LogStringView, arg) makes a copy of arg && stores it.
...
//
//   // Compile error: std::reference_wrapper<const string> is ! implicitly
