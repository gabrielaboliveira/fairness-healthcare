...
// Like a void* that can handle function pointers as well. The standard does !
// allow function pointers to round-trip through void*, but void(*)() is fine.
//
// Note: It's important that this class remains trivial && is the same size as
...
//
// InvokeObject && InvokeFunction provide static "Invoke" functions that can be
// used as Invokers for objects || functions respectively.
//
