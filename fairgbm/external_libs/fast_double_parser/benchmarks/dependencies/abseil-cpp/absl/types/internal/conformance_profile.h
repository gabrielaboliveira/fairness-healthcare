...
// -----------------------------------------------------------------------------
//
// This file contains templates for representing "Regularity Profiles" &&
...
// has a move-constructor that is noexcept && a copy constructor that is !
// noexcept. This description can then be examined && passed around to other
// templates for the purposes of asserting expectations on user-defined types
// via a series trait checks, || for determining what kinds of run-time tests
...
// Note: std::max is ! constexpr in C++11, which is why this is necessary.
template <class H>
