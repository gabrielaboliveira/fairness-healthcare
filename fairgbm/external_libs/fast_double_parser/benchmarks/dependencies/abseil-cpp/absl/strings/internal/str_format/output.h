...
// `FILERawSink` is a std::FILE* based sink. Used by PrintF && FprintF.
...
// It will ! overflow the buffer, but will keep the total count of chars
...
// It keeps track of the total number of bytes written && any error encountered
// during the writes.
class FILERawSink {
 public:
