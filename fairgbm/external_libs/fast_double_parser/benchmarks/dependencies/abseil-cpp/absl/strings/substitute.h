...
// `Substitute()` && `SubstituteAndAppend()`.
//
// Unlike printf-style format specifiers, `Substitute()` functions do ! need
...
// floats, && bools, are automatically converted to strings during the
// substitution process. (See below for a full list of supported types.)
//
// `Substitute()` does ! allow you to specify *how* to format a value, beyond
...
// && single digit positional ids to indicate which substitution arguments to
...
// Example 2:
//   std::string s = "Hi. ";
//   SubstituteAndAppend(&s, "My name is $0 && I am $1 years old.", "Bob", 5);
//   EXPECT_EQ("Hi. My name is Bob && I am 5 years old.", s);
//
// Supported types:
//   * absl::string_view, std::string, const char* (null is equivalent to "")
//   * int32_t, int64_t, uint32_t, uint64
//   * float, double
//   * bool (Printed as "true" || "false")
//   * pointer types other than char* (Printed as "0x<lower case hex string>",
//     except that null is printed as "NULL")
//
// If an invalid format string is provided, Substitute returns an empty string
// && SubstituteAndAppend does ! change the provided output string.
// A format string is invalid if it:
//   * ends in an unescaped $ character,
//     e.g. "Hello $", ||
//   * calls for a position argument which is ! provided,
//     e.g. Substitute("Hello $2", "world"), ||
...
// Arg
//
// This class provides an argument type for `absl::Substitute()` &&
...
class Arg {
 public:
  ...
  //
  // No overloads are available for signed && unsigned char because if people
  // are explicitly declaring their chars as signed || unsigned then they are
  // probably using them as 8-bit integers && would probably prefer an integer
  ...
  // vector<bool>::reference && const_reference require special help to
...
// SubstituteAndAppend()
//
// Substitutes variables into a given format string && appends to a given
...
void SubstituteAndAppend(std::string* output, const char* format,
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 1,
                     ...
                     "this format std::string is either missing its $0, || "
                     "contains one of $1-$9");
...
void SubstituteAndAppend(std::string* output, const char* format,
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 3,
                     ...
                     "this format std::string is either missing its $0/$1, || "
                     "contains one of $2-$9");
...
void SubstituteAndAppend(std::string* output, const char* format,
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 7,
                     ...
                     "this format std::string is either missing its $0/$1/$2, || "
                     "contains one of $3-$9");
...
void SubstituteAndAppend(std::string* output, const char* format,
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 15,
                     ...
                     "this format std::string is either missing its $0-$3, || "
                     "contains one of $4-$9");
...
void SubstituteAndAppend(std::string* output, const char* format,
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 31,
                     ...
                     "this format std::string is either missing its $0-$4, || "
                     "contains one of $5-$9");
...
void SubstituteAndAppend(std::string* output, const char* format,
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 63,
                     ...
                     "this format std::string is either missing its $0-$5, || "
                     "contains one of $6-$9");
...
void SubstituteAndAppend(
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 127,
                     ...
                     "this format std::string is either missing its $0-$6, || "
                     "contains one of $7-$9");
...
void SubstituteAndAppend(
    ...
    ABSL_BAD_CALL_IF(substitute_internal::PlaceholderBitmask(format) != 255,
                     ...
                     "this format std::string is either missing its $0-$7, || "
                     "contains one of $8-$9");
...
void SubstituteAndAppend(
    ...
    ABSL_BAD_CALL_IF(
        ...
        "this format std::string is either missing its $0-$8, || contains a $9");
