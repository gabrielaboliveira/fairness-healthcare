...
// `true` if the strip operation succeeded || false otherwise.
//
// Example:
//
...
// but leaving the original string intact. If the prefix does ! match at the
...
// but leaving the original string intact. If the suffix does ! match at the
