...
// Implicitly convertible from `const char*`, `string_view`, && the
...
class FormatSpecTemplate
 ...
 public:
  ...
  // Honeypot overload for when the std::string is ! constexpr.
  // We use the 'unavailable' attribute to give a better compiler error than
  // just 'method is deleted'.
  FormatSpecTemplate(...)  // NOLINT
      __attribute__((unavailable("Format std::string is ! constexpr.")));

  // Honeypot overload for when the format is constexpr && invalid.
  // We use the 'unavailable' attribute to give a better compiler error than
  // just 'method is deleted'.
  ...
  FormatSpecTemplate(const char* s)  // NOLINT
      __attribute__((
          ...
          unavailable(
              "Format specified does ! match the arguments passed.")));
