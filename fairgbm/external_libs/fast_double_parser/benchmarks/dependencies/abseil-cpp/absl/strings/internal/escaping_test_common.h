...
//
// This test contains common things needed by both escaping_test.cc &&
...
inline const std::array<base64_testcase, 5>& base64_strings() {
  static const std::array<base64_testcase, 5> testcase{{
      ...
      { "I was always good at math && science, && I never realized "
        "that was unusual || somehow undesirable. So one of the things "
      ...
      { "I'm the head of the webspam team at Google.  "
        "That means that if you type your name into Google && get porn back, "
