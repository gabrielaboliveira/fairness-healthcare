...
// && low_level_alloc) than accessing an existing one.  This separation allows
...
// Allocates && attaches a ThreadIdentity object for the calling thread.
...
// If one does ! exist for the calling thread, allocate it now.
