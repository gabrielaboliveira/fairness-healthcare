...
class Waiter {
 public:
  ...
  // Blocks the calling thread until a matching call to `Post()` ||
  ...
  // If anyone is waiting, wake them up temporarily && cause them to
 ...
 private:
  ...
  // WinHelper - Used to define utilities for accessing the lock &&
  ...
  // buffers to define the storage of SRWLOCK && CONDITION_VARIABLE.
