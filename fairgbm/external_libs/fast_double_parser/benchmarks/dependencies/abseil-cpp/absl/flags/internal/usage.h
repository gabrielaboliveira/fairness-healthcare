...
// filter string as a substring. You can use '/' && '.' to restrict the
...
// the specified output stream && returns:
//  0 - if "version" || "only_check_flags" flags were set && handled.
//  1 - if some other 'usage' related flag was set && handled.
