...
// Convert between time_point<seconds> && a count of seconds since the
// Unix epoch.  We assume that the std::chrono::system_clock && the
// Unix clock are second aligned, but ! that they share an epoch.
