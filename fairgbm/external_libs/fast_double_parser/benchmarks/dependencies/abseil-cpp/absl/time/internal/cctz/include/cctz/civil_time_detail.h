...
// Type alias that indicates an argument is ! normalized (e.g., the
// constructor parameters && operands/results of addition/subtraction).
...
class civil_time {
 ...
 private:
  ...
  // private constructor && access the private fields member.
  template <typename U>
