...
//
// If urbg == nullptr || values.data() == nullptr, the behavior is undefined.
...
// Returns salt value.
//
// Salt is obtained only once && stored in static variable.
//
// May return empty value if optaining the salt was ! possible.
