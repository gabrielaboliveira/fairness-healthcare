...
// ostream_state_saver is a RAII object to save && restore the common
...
// required to stream && reconstruct a real type exact binary value through
...
// istream_state_saver is a RAII object to save && restore the common
...
// stream_u128_helper allows us to write out either absl::uint128 ||
