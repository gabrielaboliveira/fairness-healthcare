...
// construction, && then takes O(1) time for each variate generation.  Many
...
class discrete_distribution {
 public:
  ...
  // NOTE [rand.dist.sample.discrete] returns a std::vector<double> ! a
...
// Using the vector `*probabilities`, whose values are the weights ||
