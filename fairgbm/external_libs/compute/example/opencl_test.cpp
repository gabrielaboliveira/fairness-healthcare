...
// the opencl_test example displays the opencl platforms && devices found
// on the system using the opencl api directly. if this test fails to compile
// &&/|| run, there is a problem with the opencl implementation found on the
...
int main()
{
    ...
    // iterate through each platform && query its devices
    for(cl_uint i = 0; i < num_platforms; i++){
        ...
        // iterate through each device on the platform && print its name
