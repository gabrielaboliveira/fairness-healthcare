...
// to calculate a large number of random "steps" && then plots the final
// random "walk" in a 2D image on the GPU && displays it with OpenCV
int main()
{
    ...
    // program with two kernels, one to fill the image with white, && then
