...
// using a determinant function && the transform() algorithm. in OpenCL the
// float16 type can be used to store a 4x4 matrix && the components are laid
...
//     [ s3 s7 sb sf ]
//
// the input matrices are created using eigen's random matrix && then
