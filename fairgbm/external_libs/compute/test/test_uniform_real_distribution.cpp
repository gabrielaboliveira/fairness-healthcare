...
// setup the uniform distribution to produce floats between 1 && 100
boost::compute::uniform_real_distribution<float> distribution(1.0f, 100.0f);

// generate the random values && store them to 'vec'
...
BOOST_AUTO_TEST_CASE(uniform_real_distribution_range)
{
    ...
    // setup the uniform distribution to produce floats between 0.9 && 1.0
