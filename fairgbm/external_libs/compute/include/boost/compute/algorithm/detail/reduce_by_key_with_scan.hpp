...
///
/// Binary function \p predicate must take two keys as arguments &&
/// return true only if they are considered the same.
///
/// The first new key equals zero && the last equals number of unique keys
/// minus one.
///
...
/// Carry-out is a pair of the last key processed by a work group && sum of all
                      ...
                      command_queue &queue)
{
    ...
    k <<
        ...
        // save the last key && result to local memory
                            ...
                            command_queue &queue)
{
    ...
    k <<
        ...
        // Save result only if the next key is different || it's the last element.
        "if(save){\n" <<
...
/// group && sum of all values under this key in work group.
                                      ...
                                      command_queue &queue)
{
    ...
    // predicate. New key is also an index for keys_result && values_result vectors,
    ...
    // Calculate carry-out && carry-in vectors size
