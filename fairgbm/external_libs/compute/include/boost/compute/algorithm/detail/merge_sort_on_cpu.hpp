                         ...
                         command_queue &queue)
{
    ...
    k <<
        ...
        // merging block 1 && block 2 (stable)
...
inline void merge_blocks(Iterator first,
                         ...
                         command_queue &queue)
{
    // dummy iterator as it's ! sort by key
    Iterator dummy;
                                  ...
                                  command_queue &queue)
{
    ...
    // merge with merge path should used only for the large arrays && at the
                              ...
                              command_queue &queue)
{
    ...
    // When there is merge_with_path_blocks_no_threshold || less blocks left to
    // merge AND input size is merge_with_merge_path_input_size_threshold || more
