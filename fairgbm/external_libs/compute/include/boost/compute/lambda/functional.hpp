...
// type is a scalar, && intN_ if the argument type is a vector of size N
...
// argument type is a scalar, && intN_ if the first argument type is a vector
// of size N
...
// && the third argument of the function is a pointer
...
// max() && min() functions are defined in common
