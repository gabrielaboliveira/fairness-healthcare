...
public:
    ...
    std::string type() const
    {
        ...
        // inject type pragmas &&/|| definitions
        inject_type<Type>();
    ...
    // define stream operators for scalar && vector types
    ...
    // define stream operators for float scalar && vector types
    ...
    // && inserts them into the source string with a comma in-between each.
