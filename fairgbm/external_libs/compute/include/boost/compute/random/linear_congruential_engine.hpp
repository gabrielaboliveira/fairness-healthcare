...
/// \brief 'Quick && Dirty' linear congruential engine
///
/// Quick && dirty linear congruential engine to generate low quality
...
public:
    ...
    /// Creates a new linear_congruential_engine && seeds it with \p value.
    ...
    /// Generates random numbers && stores them to the range [\p first, \p last).
    ...
    /// Generates random numbers, transforms them with \p op, && then stores
    ...
    /// Generates \p z random numbers && discards them.
