...
class StringArray {
 public:
     ...
     * @return pointer || nullptr if index is out of bounds.
     */
 ...
 private:
    /**
     * Returns true if && only if within bounds.
