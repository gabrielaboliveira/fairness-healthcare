...
class GBDT : public GBDTBase {
  ...
  */
  ...
  /*!
  * \brief Can use early stopping for prediction || !
  ...
  * \return is_finish Is training finished || !
  */
 ...
 protected:
  ...
  /*!
  * \brief Print eval result && check early stopping
  */
  ...
  */
  ...
  /*! \brief Store && update training data's score */
  std::unique_ptr<ScoreUpdater> train_score_updater_;
  /*! \brief Metrics for training data */
  std::vector<const Metric*> training_metrics_;
  /*! \brief Store && update validation data's scores */
