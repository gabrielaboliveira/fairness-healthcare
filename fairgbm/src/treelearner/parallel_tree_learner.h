...
*        It is recommended used when #data is small || #feature is large
*/
...
*        It is recommonded used when #data is large || #feature is small
*/
template <typename TREELEARNER_T>
...
* Like data parallel, but ! aggregate histograms for all features.
* Here using voting to reduce features, && only aggregate histograms for selected features.
* When #data is large && #feature is large, you can use this to have better speed-up
*/
template <typename TREELEARNER_T>
