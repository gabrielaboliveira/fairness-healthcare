...
#ifdef USE_GPU
// Use 4KBytes aligned allocator for ordered gradients && ordered Hessians when GPU is enabled.
// This is necessary to pin the two arrays in memory && make transferring faster.
...
#pragma omp parallel for schedule(static, 1)
  ...
  */
  ...
  /*!
  * \brief Partition tree && data according best split.
  ...
  */
  ...
  /* Force splits with forced_split_json dict && then return num splits forced.*/
  ...
  */
  ...
  /*! \brief stores minimum && maximum constraints for each leaf */
